...
public final class HttpEndpoint {
    ...
    // -----------------------------
    public static final String ADMIN_AI_TRAINING_BASE = ADMIN_BASE + "/ai-training";

    public static final String ADMIN_AI_TRAINING = ADMIN_AI_TRAINING_BASE;
    public static final String ADMIN_AI_TRAINING_DATA = ADMIN_AI_TRAINING_BASE + "/data";
    public static final String ADMIN_AI_TRAINING_DATA_INFO = ADMIN_AI_TRAINING_BASE + "/data-info";
    public static final String ADMIN_AI_TRAINING_METRICS = ADMIN_AI_TRAINING_BASE + "/metrics";
    public static final String ADMIN_AI_TRAINING_TRAIN = ADMIN_AI_TRAINING_BASE + "/train";
