...
public class  ArticleController {
    ...
    @Transactional(readOnly = true)
    public ResponseEntity<List<ArticleDto>> getArticlesByCategory(@PathVariable("category") String category) {
    ...
    @Transactional(readOnly = true)
    public ResponseEntity<List<ArticleDto>> searchArticles(@RequestParam("q") String q) {
